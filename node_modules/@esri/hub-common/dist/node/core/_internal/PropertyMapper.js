...
function mapProps(source, sourceKey, target, targetKey, mappings) {
    // clone the target
    const clone = __1.cloneObject(target);
    ...
    mappings.forEach((entry) => {
        ...
        const sourcePath = __1.getProp(entry, sourceKey);
        const targetPath = __1.getProp(entry, targetKey);
        // get the value from the source
        const sourceVal = __1.getProp(source, sourcePath);
        // if it's not null or undefined
        if (sourceVal !== null && sourceVal !== undefined) {
            // set it
            __1.deepSet(clone, targetPath, sourceVal);
        }
    });
    return clone;
}
