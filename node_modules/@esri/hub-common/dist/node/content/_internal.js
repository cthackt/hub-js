...
exports.getContentBoundary = (item) => {
    ...
    const isValidItemExtent = extent_1.isBBox(extent);
    ...
    switch (provenance) {
        case "item":
            geometry = isValidItemExtent ? extent_1.bBoxToPolygon(extent) : null;
            break;
        case "none":
            geometry = null;
            break;
...
exports.getHubRelativeUrl = (type, identifier, typeKeywords) => {
    ...
    if (!contentUrl) {
        ...
        else if (exports.isPageType(type)) {
 ...
 * @private
 */
exports.isPageType = (type) => ["Hub Page", "Site Page"].includes(type);
