...
const HubProjectManager_1 = require("./projects/HubProjectManager");
/**
...
class Hub {
    ...
    get projects() {
        if (!this._projectManager) {
            this._projectManager = HubProjectManager_1.HubProjectManager.init(this._contextManager);
        }
    ...
    get sites() {
        if (!this._siteManager) {
            this._siteManager = _1.HubSiteManager.init(this._contextManager);
        }
