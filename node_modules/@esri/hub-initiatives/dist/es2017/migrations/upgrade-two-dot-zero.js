 ...
 * @protected
 */
export const isIndicator = function (obj) {
    let result = false;
 ...
 * @protected
 */
export const convertIndicatorField = function (field) {
    return {
        id: field.fieldName,
        name: field.label,
 ...
 * @protected
 */
export const convertIndicatorToDefinition = function (ind) {
    const def = {
        id: ind.fieldName,
        type: "Data",
 ...
 * @protected
 */
export const extractIndicators = function (values) {
 ...
 * @protected
 */
export const flattenField = function (field) {
    return {
        id: field.id,
 ...
 * @protected
 */
export const convertIndicatorValueToSource = function (indicator) {
    return {
        type: "Feature Layer",
        url: indicator.url,
 ...
 * @protected
 */
export const convertIndicator = function (indicator) {
    const result = {
        id: indicator.id,
        type: "Data",
        name: indicator.name || indicator.id,
 ...
 * @protected
 */
export const convertInitiativeIndicators = function (values) {
 ...
 * @protected
 */
export const convertStep = function (step) {
 ...
 * @protected
 */
export const convertSteps = function (steps, values) {
