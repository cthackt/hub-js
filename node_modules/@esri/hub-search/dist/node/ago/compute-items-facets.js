...
exports.computeItemsFacets = void 0;
...
const customAggsFunctions = {
    downloadable: aggs_1.downloadableAgg,
    hasApi: aggs_1.hasApiAgg,
    collection: aggs_1.collectionAgg
};
/**
...
token, portal, authentication) {
    const aggFields = hub_common_1.getProp(params, "agg.fields");
    ...
    if (customAggs.length > 0) {
        ...
        paramsCopy.agg = {};
        const response = await get_items_1.getItems(paramsCopy, token, portal, authentication);
        customAggs.forEach(customAgg => {
            const rawCounts = customAggsFunctions[customAgg](response);
            facets1 = Object.assign(Object.assign({}, facets1), aggs_1.format(rawCounts));
        });
    }
    ...
    if (customAggs.length > 0) {
        customAggs.forEach(customAgg => {
            ...
            facets3 = Object.assign(Object.assign({}, facets3), aggs_1.format(rawCounts));
        });
    }
    ...
    if (computedFacets.categories) {
        computedFacets.categories = aggs_1.flattenCategories(computedFacets.categories);
    }
